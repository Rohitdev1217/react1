...
const Ustate = () => {
  ...
  return (
    <div className="w-full h-screen bg-zinc-300 flex justify-center items-center ">
      <div className="relative w-120 h-70 bg-zinc-200  rounded-md overflow-hidden ">
        <img
          className={`shrink-0 ${val === false ? "-translate-x-[0%]" : "-translate-x-[100%]"} object-cover w-full h-full`}
        ...
        <span
          onClick={() => setVal(() => !val)}
          className="flex w-8 h-8 bg-[#dadada7b] absolute rounded-full  left-1/2 bottom-[5%] -translate-x-[50%] -translate-y-[50%] flex items-center justify-center   items-center justify-center"
        >
          <FaArrowRight />
        </span>
      </div>
